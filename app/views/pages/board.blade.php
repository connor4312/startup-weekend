  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="addImageButton">Add Image to Board</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
...
<div id="pickerContainer">
  ...
  <div id="board" class="pull-left">
      <div id="board-title" class="pull-left">
          <h1>{{ $board->name }}</h1>
          <h5>Created {{ Carbon\Carbon::createFromTimeStamp(strtotime($board->created_at))->diffForHumans() }}</h5>
        </div>
